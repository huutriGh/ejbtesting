...
a persistence unit "ejbtestingPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ejbtesting/pom.xml":
...
artifacts ("ejbtesting-ejb.jar" and "ejbtesting-web.war") are already built. You can build
